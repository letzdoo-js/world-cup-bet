...
# ============================================================
# ClawBot Docker Setup — docker compose build + up
# ============================================================
# Usage :
#   chmod +x setup.sh
#   ./setup.sh
...
VOLUME_NAME="clawbot_world-cup-bet-workspace"
...
# Check if curriculum.json exists in the volume
...
echo "  Reset    : docker volume rm $VOLUME_NAME"
echo ""
